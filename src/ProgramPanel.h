...
class ProgramPanel : public Panel {
  public:
    ...
    const char switchA[24] = {'a', 'd', 'd', '_', 's', 'w', 'i', 't', 'c', 'h', '(', '1','3', ',', '1', ',', '4', ',', 'A', ',', 'a', ',', '0', ','};
    ...
    programTime *_nextProgramTimePtr = new programTime{ .hour = ALARM_HOUR, .minute = ALARM_MINUTE, .second = ALARM_SECOND, .programDays = {true,true,true,true,true,true,true}, .programEnabled = true, .delay = PROGRAM_DELAY };
